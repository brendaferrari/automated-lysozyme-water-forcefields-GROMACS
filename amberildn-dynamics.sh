...
current_abs_dir=$(pwd)
input_dir=$current_abs_dir/files/amberildn
...
echo "6" | gmx pdb2gmx -f $clean_file -o $processed_file -water tip3p 
mv {posre.itp,topol.top} files/amberildn
