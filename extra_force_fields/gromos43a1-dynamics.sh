...
current_abs_dir=$(pwd)
input_dir=$current_abs_dir/files/gromos43a1
...
echo "9" | gmx pdb2gmx -f $clean_file -o $processed_file -water spc 
mv {posre.itp,topol.top} files/gromos43a1
