...
current_abs_dir=$(pwd)
input_dir=$current_abs_dir/files/gromos53a5
...
echo "12" | gmx pdb2gmx -f $clean_file -o $processed_file -water spc 
mv {posre.itp,topol.top} files/gromos53a5
...
echo "11 0" | gmx energy -f $input_dir/em.edr -o $output_dir/potential.xvg
...
echo "17 0" | gmx energy -f $input_dir/nvt.edr -o $output_dir/temperature.xvg
...
echo "19 0" | gmx energy -f $input_dir/npt.edr -o $output_dir/pressure.xvg
echo "25 0" | gmx energy -f $input_dir/npt.edr -o $output_dir/density.xvg
