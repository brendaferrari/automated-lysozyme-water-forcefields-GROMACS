...
current_abs_dir=$(pwd)
input_dir=$current_abs_dir/files/gromos45a3
...
echo "11" | gmx pdb2gmx -f $clean_file -o $processed_file -water spc 
mv {posre.itp,topol.top} files/gromos45a3
